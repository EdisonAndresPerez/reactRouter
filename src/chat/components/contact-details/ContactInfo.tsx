 ...
 *
 * Este componente muestra la información detallada del contacto actualmente seleccionado en el chat.
 *
 * Estructura:
 * - Avatar grande, nombre, tipo de cuenta y estado (online/offline)
 * - Información de contacto: email, teléfono, ID de cliente
 * - Detalles de la cuenta: plan, antigüedad, último pago
 * - Botón para ver el perfil completo
 *
 * Buenas prácticas:
 * - Usa TailwindCSS para estilos y responsividad.
 * - Presenta la información de forma clara y accesible.
 */
